...
@section('content')
    ...
    <h4 class="container-fluid py-3 mb-4">
        <span class="text-muted fw-light"> <a href="/admin">Commercial</a> /</span> Dashboard
    </h4>
    ...
    <div class="container-fluid">
            ...
            <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
                ...
                <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center">
                    <h3 class="card-title mb-4 lh-sm px-md-5 lh-lg">
                        Maximisez vos gains avec notre programme de

                        <span class="text-primary fw-medium text-nowrap">Commission
                            Parrainage </span>.
                    </h3>
                    <p class="mb-3">
                        Rejoignez notre réseau étendu et profitez des avantages de notre système de commissions à plusieurs
                        niveaux. Encouragez les inscriptions grâce à votre réseau et bénéficiez directement de chaque cours
                        acheté par vos filleuls.

                    </p>

                    <h5>Votre code de parrainage :</h5>

                    <div class="d-flex align-items-center justify-content-between app-academy-md-80">

                        <input type="text" class="form-control me-2" value="{{ auth()->user()->referral_code }}"
                            id="referralCode" readonly>
                        <button type="submit" class="btn btn-primary btn-icon" onclick="copyToClipboard()"><i
        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex justify-content-between align-items-center mt-3 gap-3">
                            <h4 class="mb-0">{{ auth()->user()->commissions->count() }}</h4>
            ...
            <div class="col-xl-2 col-md-4 col-6 mb-4">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5 class="card-title mb-0">Parrainage</h5>
                        <small class="text-muted">Cette Semaine</small>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-2 col-md-4 col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title mb-1 pt-2">Total Gains</h5>
                        <small class="text-muted">Cette Semaine</small>
                        <p class="mb-2 mt-1">{{ auth()->user()->commissions->sum('amount') }}</p>
                        <div class="pt-1">
            ...
            <div class="col-xl-2 col-md-4 col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title mb-1 pt-2">Total Filleul </h5>
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="badge bg-label-secondary rounded p-2"><i
                                            class="ti ti-shopping-cart ti-sm"></i>
                                    </div>
                ...
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                        <div class="card-title m-0 me-2">
                            <h5 class="m-0 me-2">Liste des Filleuls</h5>
                            <small class="text-muted">Aperçu de vos affiliations</small>
                        </div>
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="referralListDropdown" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="ti ti-dots-vertical ti-sm text-muted"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="referralListDropdown">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            <!-- Dynamic list of referrals -->
                            @foreach (auth()->user()->referrals as $referral)
                                <li class="d-flex mb-3 pb-1 align-items-center">
                                    <img src="{{ asset('assets/img/icons/users/user.png') }}" alt="User"
                                        height="28" class="me-3 rounded-circle">
                                    <div class="d-flex w-100 align-items-center gap-2">
                                        <div class="flex-grow-1">
                                            <h6 class="mb-0">{{ $referral->name }}</h6>
                                            <small>Date de parrainage : {{ $referral->created_at->format('d/m/Y') }}</small>
                                        </div>
                                        <div class="badge bg-label-primary">{{ $referral->status }}</div>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            ...
                            <li class="mb-3 pb-1 d-flex">
                                <div class="d-flex w-50 align-items-center me-3">
                                    <img src="{{ asset('assets/img/icons/brands/bootstrap-logo.png') }}"
