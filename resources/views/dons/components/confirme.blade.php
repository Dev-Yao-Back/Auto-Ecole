      ...
      <ul class="list-group list-group-horizontal-md">
          ...
          <li class="col-12 list-group-item flex-fill p-4 text-heading">
              ...
              <p class="fw-medium mb-3">
                  ...
                  <i class="ti ti-credit-card"></i> Subvention : {{ number_format($lib_subvention ?? 0, 0, '', ' ') }} FCFA<br>
    ...
    <div class="col-xl-12">
        <div class="border rounded p-4 pb-3">
            ...
            <dl class="row mb-0">
                ...
                <dd class="col-6 text-end"><span
                  class="badge bg-label-danger ms-1">{{ number_format($reste ?? 0, 0, '', ' ') }} FCFA</span></dd>
            </dl>
            <hr class="mx-n4">
            <dl class="row mb-0">
                <dt class="col-6 text-heading">Subvention</dt>
                <dd class="col-6 fw-medium text-end text-heading mb-0">{{ number_format($lib_subvention ?? 0, 0, '', ' ') }} FCFA</dd>
            </dl>
            <hr class="mx-n4">
            <dl class="row mb-0">
                <dt class="col-6 text-heading">Total</dt>
                <dd class="col-6 fw-medium text-end text-heading mb-0">{{ number_format($total ?? 0, 0, '', ' ') }} FCFA</dd>
            </dl>
        </div>
        <div class="row my-1 gy-2 d-flex justify-content-center">
            ...
            <div class="col d-grid ">
                <button class="btn btn-primary text-lg-start" wire:click='restartComponent'>Incrire un Nouveau</button>
            </div>
            @else
            <div class="col d-grid ">
